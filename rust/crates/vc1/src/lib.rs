...
mod tests {
    ...
    const EXTRADATA: &[u8] = &[
        0x00, 0x00, 0x01, 0x0f, 0xda, 0x00, 0x3b, 0xf2, 0x1b, 0xca, 0x3b, 0xf8, 0x86, 0xf1,
        0x80, 0xc9, 0x09, 0xaf, 0xa1, 0x1f, 0x27, 0x04, 0x00, 0x00, 0x01, 0x0e, 0x4c, 0x97,
        0xf8, 0x80,
    ];
    ...
    fn reads_a_disc_sequence_header() {
        ...
        assert_eq!((shape.sequence.max_width, shape.sequence.max_height), (1920, 1080));
