...
# -> target/release/bundle/appimage/SmartCut_0.5.13_amd64.AppImage
```
...
```bash
./SmartCut_0.5.13_amd64.AppImage --appimage-extract >/dev/null
...
```bash
./gui/build-linux.sh
# -> gui/src-tauri/target/release/bundle/linux/SmartCut-0.5.13-linux-x86_64.tar.gz
# -> gui/src-tauri/target/release/bundle/linux/smartcut_0.5.13_amd64.deb
```
...
# -> gui/src-tauri/target/x86_64-pc-windows-msvc/release/bundle/nsis/SmartCut_0.5.13_x64-setup.exe
