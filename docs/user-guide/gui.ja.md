...
|---|---|
| 最上段 | ファイル名 |
| 情報バー | 無劣化点の数・解像度・fps・走査方式・音声・コーデック。右端に**字幕**・**トラック**・**CM を検出** |
...
情報バーの右端に**字幕**があります。既定は「表示しない」で、選ぶとプレビューの
...
- 字幕を出しているあいだ、フレーム番号と時刻の表示は絵の**上端**へ移ります。
  どちらも絵の下を使うので、動かせないほうを優先しています。
- 再生中も追従します。
