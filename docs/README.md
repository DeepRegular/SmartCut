...
| [Reading a disc](developers/disc.md) | Blu-ray (BDAV and BDMV) and DVD-Video, from a folder or an `.iso`: UDF, IFO tables, ARIB text, one row per clip, and the chooser |
