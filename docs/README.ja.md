...
| [バッチ処理](user-guide/batch.ja.md) | 一晩ぶんの録画をまとめて扱う。クリップ一覧、裏で動く 3 本の列、書き出し |
...
| [ディスクを読む](developers/disc.ja.md) | Blu-ray（BDAV / BDMV）も DVD-Video も、フォルダーからも `.iso` からも読む。UDF、IFO のテーブル、ARIB のテキスト、クリップごとの一覧、選択ダイアログ |
