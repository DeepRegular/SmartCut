...
| [まとめて処理する](user-guide/batch.ja.md) | 一晩ぶんの録画をまとめて片付ける。裏で動く処理、複製、まとめて書き出し、誰もいないあいだにプロジェクトを順に書き出すバッチ出力ツール |
...
| [ディスクに収める](technical/transrate.ja.md) | 入りきらない一晩ぶんを、デコードせずに映像だけ小さく書き直して 1 枚に収める。再量子化、係数の切り捨て、レート制御、70 万枚で確かめた同一性 |
