...
- **[ユーザーガイド](#ユーザーガイド)** — 使い方。専門知識は必要ありません。
...
| [まとめて処理する](user-guide/batch.ja.md) | 一晩分の録画をまとめて片付ける。裏で動く処理、複製、まとめて書き出し、誰もいないあいだにプロジェクトを順に書き出すバッチ出力ツール |
...
| [ディスクを書く](technical/bdav.ja.md) | 一晩分のカットを BDAV フォルダーとして書き出す。到着時刻、エントリーポイントマップ、番組名の出どころ、意味が判明せず実物から写した欄 |
