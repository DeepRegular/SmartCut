...
const CATALOG = {
  ja: {
    ...
    "prefs.sidecarNote":
      "カット編集を開くとき、録画の隣にあるファイルを読みます。" +
      "キーフレーム情報は位置の一覧なので、印が並ぶだけです。" +
      "Trim は残す区間そのものなので、カット済みの状態で開きます。" +
      "CM 検出結果は、検出した直後と同じ帯と印に戻ります。" +
      "隣にあるのが 1 つだけなら、この設定に関わらずそれを読みます。" +
      "隣のファイルを読んだときは、CM 検出の結果に印は置きません。帯だけ出ます。",
    ...
    "prefs.cmKeyframesNote":
      ...
      "録画の隣のファイルを読んだときは、入れてあっても印は置きません。" +
    ...
    "cm.failed": "検出できません: {e}",
    "cm.besideMarks": "{note}（録画の隣のファイルを読んだので、印は置いていません）",
