...
const CATALOG = {
  ja: {
    ...
    "rowmenu.undetectBlank": "黒白 検出予約を取り消す",
    "rowmenu.undetectBlankBlack": "黒 検出予約を取り消す",
    "rowmenu.undetectBlankWhite": "白 検出予約を取り消す",
    ...
    "editor.keyframes.edgeOpen.black": "黒の区間の始まり",
    "editor.keyframes.edgeOpen.white": "白の区間の始まり",
    "editor.keyframes.edgeOpen.quiet": "無音の区間の始まり",
    "editor.keyframes.edgeClose.black": "黒の区間の終わり",
    "editor.keyframes.edgeClose.white": "白の区間の終わり",
    "editor.keyframes.edgeClose.quiet": "無音の区間の終わり",
    "editor.keyframes.edgeBoth.black": "1 フレームだけの黒の区間（始まりと終わりが同じ）",
    "editor.keyframes.edgeBoth.white": "1 フレームだけの白の区間（始まりと終わりが同じ）",
    "editor.keyframes.edgeBoth.quiet": "始まりと終わりが同じフレームにある無音の区間",
  ...
  en: {
    ...
    "rowmenu.undetectBlank": "Cancel blank detection",
    "rowmenu.undetectBlankBlack": "Cancel black detection",
    "rowmenu.undetectBlankWhite": "Cancel white detection",
    ...
    "list.stoppedAll": "Analysis stopped",
    "dialog.video": "Video",
    ...
    "channels.surround71": "7.1ch (8 channels)",
    ...
    "editor.keyframes.edgeOpen.black": "Where a black stretch begins",
    "editor.keyframes.edgeOpen.white": "Where a white stretch begins",
    "editor.keyframes.edgeOpen.quiet": "Where a quiet stretch begins",
    "editor.keyframes.edgeClose.black": "Where a black stretch ends",
    "editor.keyframes.edgeClose.white": "Where a white stretch ends",
    "editor.keyframes.edgeClose.quiet": "Where a quiet stretch ends",
    "editor.keyframes.edgeBoth.black": "A black stretch one frame long, beginning and ending here",
    "editor.keyframes.edgeBoth.white": "A white stretch one frame long, beginning and ending here",
    "editor.keyframes.edgeBoth.quiet": "A quiet stretch that begins and ends on this frame",
