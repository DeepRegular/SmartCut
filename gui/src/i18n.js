...
const CATALOG = {
  ja: {
    ...
    "editor.dropTitle": "編集を捨てる",
    "editor.dropBody": "この画面でした編集を捨てて閉じます。よろしいですか？",
  ...
  en: {
    ...
    "editor.dropTitle": "Drop the edit",
    "editor.dropBody": "Everything done to this recording in here will be dropped. Close the window?",
