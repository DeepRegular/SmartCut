...
const CATALOG = {
  ja: {
    ...
    "batch.open": "バッチ出力ツール",
    "batch.openNote": "バッチ出力ツールは別ウィンドウで動きます。この画面を閉じても書き出しは続きます",
    "batch.opened": "バッチ出力ツールを起動しました",
    "batch.toolRunning": "バッチ出力ツールが動いています",
    "batch.toolIdle": "バッチ出力ツールは動いていません",
    ...
    "batch.afterNote": "最後のジョブが終わってから実行します",
    ...
    "batch.summary": "ジョブ {done} 件を出力しました{failed}{stopped}　経過 {elapsed}",
    "batch.summaryFailed": "　失敗 {n} 件",
    "batch.summaryStopped": "　（中止されました）",
  ...
  en: {
    ...
    "batch.addCurrent": "Add this list",
    "batch.up": "Up",
    "batch.down": "Down",
    "batch.remove": "Remove",
    "batch.clear": "Clear",
    "batch.windowTitle": "Batch — SmartCut",
    "batch.open": "Batch tool",
    "batch.openNote": "The batch tool runs in a window of its own. Closing this one does not stop it",
    "batch.opened": "The batch tool has been started",
    "batch.toolRunning": "The batch tool is running",
    "batch.toolIdle": "The batch tool is not running",
    "batch.queueFailed": "The queue could not be saved: {e}",
    "batch.run": "Start batch",
    "batch.stop": "Stop batch",
    "batch.stateLbl": "Status:",
    "batch.afterLbl": "When done:",
    "batch.afterNothing": "Nothing",
    "batch.afterSleep": "Sleep",
    "batch.afterShutdown": "Shut down",
    "batch.afterNote": "After the last job has finished",
    ...
    "batch.at": "Running: {name}",
    "batch.stopping": "Stopping…",
    "batch.summary": "{done} jobs written{failed}{stopped}   elapsed {elapsed}",
    "batch.summaryFailed": "   {n} failed",
    "batch.summaryStopped": "   (stopped)",
