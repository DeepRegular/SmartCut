...
const CATALOG = {
  ja: {
    ...
    "tracks.beside": "字幕 {lang}: カットの傍らに .idx と .sub で書き出します   id 0x{pid}",
    "outset.subtitles": "DVD の字幕:",
    "subtitles.beside": "そのまま傍らに (.idx / .sub)",
    "subtitles.pgs": "変換してカットの中に (PGS)",
    "tracks.main": "主音声",
  ...
  en: {
    ...
    "tracks.beside": "Subtitles {lang}: written beside the cut, as .idx and .sub   id 0x{pid}",
    "outset.subtitles": "A DVD's subtitles:",
    "subtitles.beside": "Beside the cut, untouched (.idx / .sub)",
    "subtitles.pgs": "Converted, inside the cut (PGS)",
    "tracks.main": "main",
    "tracks.pid": "PID 0x{pid}",
