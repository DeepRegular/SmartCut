...
| Platform | File | Notes |
|---|---|---|
| **Linux** | `SmartCut_0.6.3_amd64.AppImage` | Make it executable and run it |
| **Linux** | `SmartCut-0.6.3-linux-x86_64.tar.gz` | Unpack and run `./smartcut`. Use this if you would rather not deal with FUSE |
| **Linux (Debian/Ubuntu)** | `smartcut_0.6.3_amd64.deb` | `sudo apt install ./smartcut_0.6.3_amd64.deb`. Only 3.9 MB, because it uses the FFmpeg already on your system |
| **Windows** | `SmartCut_0.6.3_x64-setup.exe` | Installer |
| **Windows** | `smartcut-portable-x64-0.6.3.zip` | Unzip and run `smartcut.exe` |
